...
public class DR_HalfGaugeNetLogic : BaseNetLogic
{
    ...
    private void loadValues()
    {
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Half Guage Debug", "Smart Trend Debug Enabled: " + DebugEnable);
            Log.Info("DataReady - OEE Half Guage Debug", "Loading Values");
        }
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Half Guage Debug", "OEE Datastore: " + dataStore.BrowseName);
        }
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Half Guage Debug", "Loading Values Complete");
        }
    }
    ...
    public string colorString(Color color)
    {
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Half Guage Debug", "Converting Color");
        }
        string updatedColor = "#" + color.R.ToString("x2") + color.G.ToString("x2") + color.B.ToString("x2");

        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Half Guage Debug", "Color Convertion: " + Convert.ToString(color.ARGB) + " Color String: " + updatedColor);
        }
        return updatedColor;
    ...
    private void readDatabase()
    {
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Half Guage Debug", "Read Database");
        }
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Half Guage Debug", "Query WHERE: " + queryWhere);
        }
        ...
        if (DebugEnable == true)
        {
            Log.Info("DataReady - OEE Half Guage Debug", "Query: " + dataQuery);
        }
        dataStore.Query(dataQuery, out resultsHeader, out resultsData);
        if (DebugEnable == true)
        {
            Log.Info("DataReady - OEE Half Guage Debug", "Query Result Length: " + resultsData.GetLength(0));
        }
    }
    ...
    private void dataStaging()
    {
        ...
        AlertValue = (180 / (MaxValue - MinValue)) * (TargetThreshold - 5 - MinValue);
        WarningValue = (180 / (MaxValue - MinValue)) * (5);
        TargetValue = (180 / (MaxValue - MinValue)) * (MaxValue - TargetThreshold);
    ...
    public void createStrings()
    {
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Half Guage Debug", "Creating JS Strings");
        }
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Half Guage Debug", "JS Strings Completed");
        }
    }
    ...
    public void writeOutputs()
    {
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Half Guage Debug", "Write JS Strings to files");
        }
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Half Guage Debug", jsFilePath + " File Write Complete");
        }
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Half Guage Debug", htmlFilePath + " File Write Complete");
        }
    }
    ...
    public override void Start()
    {
        ...
        ImageID = "HG_" + Guid.NewGuid().ToString().ToUpper();
