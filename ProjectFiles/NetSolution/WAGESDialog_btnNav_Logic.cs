...
public class WAGESDialog_btnNav_Logic : BaseNetLogic
{
    ...
    {
        Thread.Sleep(50);
        string FullPath = Owner.GetVariable("FullPath").Value;
        NodeId PathNode = Project.Current.GetObject(FullPath).NodeId;
