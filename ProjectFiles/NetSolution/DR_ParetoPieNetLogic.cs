...
public class DR_ParetoPieNetLogic : BaseNetLogic
{
    ...
    private void loadValues()
    {
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", "Pareto Pie Debug Enabled: " + DebugEnable);
            Log.Info("DataReady - OEE Pareto Pie Debug", "Pareto Pie Loading Values");
        }
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", "OEE Datastore: " + dataStore.BrowseName);
        }
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", "Pareto Pie Loading Values Complete");
        }
    }
    ...
    public string colorString(Color color)
    {
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", "Pareto Pie Converting Color");
        }
        string updatedColor = "#" + color.R.ToString("x2") + color.G.ToString("x2") + color.B.ToString("x2");

        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", "Pareto Pie Color Convertion: " + Convert.ToString(color.ARGB) + " Color String: " + updatedColor);
        }
        return updatedColor;
    }
    ...
    private void readDatabase()
    {
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", "Pareto Pie Read Database");
        }
        queryWhere = "(MachineGUID = '" + ModelName + "') AND (State<>'" + FilterStateValue + "') AND (StartTime >= '" + StartDateTime.ToString("yyyy-MM-ddTHH:mm:ss.fff") + "') AND (StartTime < '" + EndDateTime.ToString("yyyy-MM-ddTHH:mm:ss.fff") + "')";
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", "Pareto Pie Query WHERE: " + queryWhere);
        }
        ...
        if (DebugEnable == true)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", "Pareto Pie Query: " + dataQuery);
        }
        dataStore.Query(dataQuery, out resultsHeader, out resultsData);
        if (DebugEnable == true)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", "Pareto Pie Query Result Length: " + resultsData.GetLength(0));
        }
    }
    ...
    public void createStrings()
    {
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", "Pareto Pie Creating JS Strings");
        }
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", "Pareto Pie JS Strings Completed");
        }
    }
    ...
    public void writeOutputs()
    {
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", "Pareto Pie Write JS Strings to files");
        }
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", jsFilePath + " Pareto Pie File Write Complete");
        }
        ...
        if (DebugEnable)
        {
            Log.Info("DataReady - OEE Pareto Pie Debug", htmlFilePath + " Pareto Pie File Write Complete");
        }
    }
    ...
    public override void Start()
    {
        ...
        ImageID = "PPC_" + Guid.NewGuid().ToString().ToUpper();
