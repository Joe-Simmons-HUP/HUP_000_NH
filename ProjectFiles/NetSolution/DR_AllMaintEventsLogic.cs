...
public class DR_AllMaintEventsLogic : BaseNetLogic
{
    ...
    private void readDatabase()
    {
        ...
        queryWhere = "(MachineGUID = '" + ModelName + "') AND (Severity<>'0') AND (Timestamp >= '" + StartDateTime.ToString("yyyy-MM-ddTHH:mm:ss.fff") + "') AND (Timestamp <= '" + EndDateTime.ToString("yyyy-MM-ddTHH:mm:ss.fff") + "')";
        if (DebugEnable)
        {
